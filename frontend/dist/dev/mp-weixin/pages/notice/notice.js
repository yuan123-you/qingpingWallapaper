  ...
  setup(__props) {
      ...
      try {
        ...
        if (res && res.noticeList) {
          if (refresh) {
            ...
            noticeList.value = [...noticeList.value, ...res.noticeList];
          }
          hasMore.value = res.noticeList.length >= pageSize;
        }
      } catch (error) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        e: common_vendor.o(loadMore, "cc")
      });
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-6802562a"]]);

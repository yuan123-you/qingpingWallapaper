...
exports.isFilterExpr = exports.removeAttribute = exports.isStaticLiteral = exports.isReferencedByIds = exports.findReferencedScope = exports.rewriteExpression = exports.rewriteExpressionWithoutProperty = exports.parseExprWithRewriteClass = exports.parseExprWithRewrite = exports.rewriteWithHelper = exports.rewriteSpreadElement = exports.filterName = exports.filterObserverName = exports.SCOPED_SLOT_IDENTIFIER = exports.FILTER_SET_ELEMENT_ANIMATION = exports.FILTER_SET_ELEMENT_STYLE = exports.FILTER_MODULE_FILE_NAME = exports.FILTER_MODULE_NAME = exports.ATTR_SET_ELEMENT_ANIMATION = exports.ATTR_SET_ELEMENT_STYLE = exports.ATTR_ELEMENT_TAG = exports.ATTR_ELEMENT_ID = exports.ATTR_COM_TYPE = exports.ATTR_VUE_REF_IN_FOR = exports.ATTR_VUE_REF = exports.ATTR_VUE_PROPS = exports.ATTR_VUE_SLOTS = exports.ATTR_VUE_ID = void 0;
...
function filterObserverName(name) {
    return uni_shared_1.ATTR_CHANGE_PREFIX + name;
}
...
function isFilterExpr(node, context) {
    if (context.filters.length && (0, uni_cli_shared_1.isCompoundExpressionNode)(node)) {
        const firstChild = node.children[0];
        if (!(0, shared_1.isString)(firstChild) &&
            !(0, shared_1.isSymbol)(firstChild) &&
            (0, uni_cli_shared_1.isSimpleExpressionNode)(firstChild) &&
...
exports.isFilterExpr = isFilterExpr;

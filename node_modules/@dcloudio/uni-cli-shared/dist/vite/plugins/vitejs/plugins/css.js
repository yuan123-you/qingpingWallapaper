...
function preprocessCss(content, isNVue = false, filename) {
    if (content.includes('#endif')) {
        return isNVue ? (0, preprocess_1.preNVueCss)(content, filename) : (0, preprocess_1.preCss)(content, filename);
    }
    return content;
}
/**
...
async function rebaseUrls(file, rootFile, alias, isNVue = false) {
    ...
    let contents = preprocessCss(fs_extra_1.default.readFileSync(file, 'utf-8'), isNVue, file);
...
function rewriteScssReadFileSync() {
    ...
    fs_1.default.readFileSync = ((filepath, options) => {
        ...
        // 目前无法区分app-nvue
            ...
            return (0, preprocess_1.preCss)(content, filepath);
        }
        return content;
    });

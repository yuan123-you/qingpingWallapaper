...
function createCopyComponentDirs(dir) {
    ...
    const { appJson } = (0, json_1.parseMiniProgramPagesJson)(fs_1.default.readFileSync(path_1.default.resolve((0, utils_1.normalizePath)(inputDir), 'pages.json'), 'utf8'), platform, { subpackages: true });

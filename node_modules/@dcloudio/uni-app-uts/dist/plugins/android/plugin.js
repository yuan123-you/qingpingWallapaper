...
function uniAppPlugin() {
    ...
    emptyTscDir();
    let resolvedConfig;
    const resolveWorkers = () => (0, uni_cli_shared_1.getWorkers)();
    const uniXKotlinCompiler = process.env.UNI_APP_X_TSC === 'true'
        ? (0, uni_cli_shared_1.resolveUTSCompiler)().createUniXKotlinCompilerOnce({ resolveWorkers })
        : null;
    const changedFiles = [];
    ...
    return {
        ...
        async writeBundle() {
            ...
            const res = await compileApp(path_1.default.join(uvueOutputDir, 'main.uts'), {
                ...
                inputDir: uvueOutputDir,
                outputDir: outputDir,
                package: (0, uni_cli_shared_1.parseUniXAppAndroidPackage)(manifestJson.appid || utils_1.DEFAULT_APPID),
                ...
                if (process.env.NODE_ENV === 'development') {
                    ...
                    if (res.changed) {
                        ...
                        if (!res.changed.length && res.kotlinc) {
                            throw (0, uni_cli_shared_1.createErrorWithBlockFlag)('编译失败');
                        }

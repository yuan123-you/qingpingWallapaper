    ...
    return {
        ...
        onWarn(warning) {
            if (pluginContext && warning.errorType !== 'css') {
                ...
                (0, uni_cli_shared_1.onVueTemplateCompileLog)('warn', warning, code, relativeFileName);
            }
        },
        onError(error) {
            if (pluginContext && error.errorType !== 'css') {
                ...
                (0, uni_cli_shared_1.onVueTemplateCompileLog)('error', error, code, relativeFileName);
            }
        },
        parseUTSComponent: uni_cli_shared_1.parseUTSComponent,
        parseUTSCustomElement: uni_cli_shared_1.parseUTSCustomElement,
    };
}

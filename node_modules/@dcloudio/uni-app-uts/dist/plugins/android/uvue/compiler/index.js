...
const transformAssetUrl_1 = require("../sfc/compiler/template/transformAssetUrl");
const transformSrcset_1 = require("../sfc/compiler/template/transformSrcset");
function getBaseTransformPreset(prefixIdentifiers) {
    return [
        [
            ...
            uni_cli_shared_1.transformLineBreak,
        ],
        {
...
function compile(template, options) {
    (0, runtimeHelpers_1.initRuntimeHelpersOnce)();
    ...
    // 重要不能传入base
    const assetOptions = (0, transformAssetUrl_1.normalizeOptions)((0, uni_cli_shared_1.createUniVueTransformAssetUrls)(''));
    (0, transform_1.transform)(ast, (0, shared_1.extend)({}, options, {
        nodeTransforms: [
            ...nodeTransforms,
            (0, transformAssetUrl_1.createAssetUrlTransformWithOptions)(assetOptions),
            (0, transformSrcset_1.createSrcsetTransformWithOptions)(assetOptions),

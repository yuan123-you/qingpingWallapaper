...
export declare function normalizeManifestJson(platform: 'app-android' | 'app-ios' | 'app-harmony', userManifestJson: Record<string, any>): Record<string, any>;
...
export declare const DOM2_CSS_CACHE_MAP: Map<string, string>;

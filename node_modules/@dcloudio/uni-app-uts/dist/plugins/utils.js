...
function createUniOptions(platform) {
    return {
        compiler: process.env.UNI_APP_X_DOM2 === 'true'
            ...
            ? {
                isNativeTag(tag) {
                    if (process.env.UNI_APP_X_DOM2 === 'true') {
                        return (0, uni_shared_1.isDom2AppNativeTag)(tag);
                    }
...
function normalizeManifestJson(platform, userManifestJson) {
    ...
    return (0, uni_cli_shared_1.initI18n)(manifest);
}
...
exports.isVue = isVue;
exports.DOM2_CSS_CACHE_MAP = new Map();

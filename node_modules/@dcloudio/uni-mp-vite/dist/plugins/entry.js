...
function initSubPackages() {
    ...
    const { appJson } = (0, uni_cli_shared_1.parseMiniProgramPagesJson)(fs_1.default.readFileSync(path_1.default.resolve(inputDir, 'pages.json'), 'utf8'), platform, { subpackages: true });
